...
class Client_1:
    ...
    def Training(self):
        ...
        #print("***********************************")
        client['dataset']     = torch.utils.data.DataLoader(Load, batch_size= args.local_batches )  #reading data file from the dataset
        ...
        client_1_model=client['model']
        print("________________________")
        print("parameters from client_1")
        print("________________________")

        print(client_1_model.state_dict())
        torch.save(client_1_model.state_dict(),"fedavg_1.txt")
        return (client_1_model.state_dict())
